...
const Recipe = () => {
    ...
    const getRecipe = async() =>{
        ...
        const url = `https://data-base-api.herokuapp.com/recipes/get_recipe?id_recipe=${id}&status=${status}`;
    ...
    const getRecipeProducts = async() =>{
        ...
        const url = `https://data-base-api.herokuapp.com/recipes/get_recipe_products?id_recipe=${id}`;
        const response = await fetch(url,{
            method: 'GET',
            credentials: 'omit',
            headers: {'Content-Type': 'application/json'},
    ...
    const getRecipeCategories = async() =>{
        ...
        const url = `https://data-base-api.herokuapp.com/recipes/get_recipe_categories?id_recipe=${id}`;
        const response = await fetch(url,{
            method: 'GET',
            credentials: 'omit',
            headers: {'Content-Type': 'application/json'},
    ...
    const likeRecipe = async(data) => {
        ...
        const url = `https://data-base-api.herokuapp.com/recipes/like_recipe?id_recipe=${id}`;
        const response = await fetch(url,{
            method: 'POST',
            credentials: 'omit',
            headers: {'Content-Type': 'application/json'},
    ...
    const getComments = async() => {
        const url = `https://data-base-api.herokuapp.com/recipes/get_comments?id_recipe=${id}`;
        const response = await fetch(url,{
            method: 'GET',
            credentials: 'omit',
            headers: {'Content-Type': 'application/json'},
    ...
    const addComment = async(data) => {
        ...
        data["token"] = localStorage.getItem('token')
        const url = `https://data-base-api.herokuapp.com/recipes/add_comment?id_recipe=${id}`;
        const response = await fetch(url,{
            method: 'POST',
            credentials: 'omit',
            headers: {'Content-Type': 'application/json'},
    ...
    const dislikeRecipe = async() => {
        const url = `https://data-base-api.herokuapp.com/recipes/dislike_recipe?id_recipe=${id}`;
        const response = await fetch(url,{
            method: 'POST',
            credentials: 'omit',
            headers: {'Content-Type': 'application/json'},
